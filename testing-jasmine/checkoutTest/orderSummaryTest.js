import { renderAgain } from "../../scripts/checkout/orderSummary.js";
import { loadFromStorage, cart } from "../../data/cart.js";
import { loadProducts  } from "../../data/products.js";
describe('test suite: renderingOrderSummary', () => {
    ...
    expect(document.querySelectorAll('.js-cart-container').length
    ).toEqual(2)
...
document.querySelector('.js-test-container').innerHTML = ``;
    ...
    expect(document.querySelector(`.js-cart-item-${productId2}`)).not.toEqual(null);
